...
@Test
func usrStoreClientTest() async throws {
    ...
    try await withDependencies {
        ...
        let response = try await usrStoreClient.extract(indexStoreURL: indexStoreURL, projectRootURL: testFileURL)
        let expectedResult = USRStore(
            definitionUSRs: [
                // ParameterType
